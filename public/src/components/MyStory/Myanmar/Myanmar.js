...
const Myanmar = ({ offsetY }) => {
    ...
    return (
        ...
        >
            ...
            ></img>
            <h1
                className={styles["biography-left"]}
                style={setStyle("X", -0.3)}
            >
                I was born and raised in
                <div className={styles.myanmar}>MYANMAR,</div> a country
                enriched with culture and beauty the world has yet to see.
            </h1>
            ...
            ></img>
            <h1
                className={styles["biography-right"]}
                style={setStyle("X", 0.6)}
            >
                As exquisite as Myanmar was, she was also technologically
                regressive, thanks to a power-hungry military.
            </h1>
            ...
            <img
                ...
                style={setStyle("X", -1)}
            ></img>
            <h1 className={styles["biography-down"]} style={setStyle("Y", 0.6)}>
                Growing up, I was exposed to very little technology. I nearly
                majored in the humanities for college. But fate had other plans.
                At age 16, I discovered coding.
            </h1>
        </div>
    );
};
